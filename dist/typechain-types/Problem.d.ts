...
export interface ProblemInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "_updateSolution", values: [string, string]): string;
    ...
    encodeFunctionData(functionFragment: "modifyChecker", values: [string]): string;
    ...
    decodeFunctionResult(functionFragment: "_updateSolution", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "modifyChecker", data: BytesLike): Result;
...
export interface Problem extends BaseContract {
    ...
    functions: {
        ...
        _updateSolution(user: string, solution: string, overrides?: Overrides & {
        ...
        modifyChecker(newChecker: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        MAX_OUTPUT_SIZE(overrides?: CallOverrides): Promise<number>;
        _updateSolution(user: string, solution: string, overrides?: CallOverrides): Promise<void>;
