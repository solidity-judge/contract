...
export interface SimpleCheckerInterface extends utils.Interface {
    contractName: "SimpleChecker";
    functions: {
...
export interface SimpleChecker extends BaseContract {
    contractName: "SimpleChecker";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SimpleCheckerInterface;
