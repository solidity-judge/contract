...
export interface GateInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "deployAndSubmit", values: [BytesLike, string]): string;
    ...
    decodeFunctionResult(functionFragment: "deployAndSubmit", data: BytesLike): Result;
...
export interface Gate extends BaseContract {
    ...
    functions: {
        deploy(bytecode: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        deployAndRun(bytecode: BytesLike, input: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        deployAndSubmit(bytecode: BytesLike, problem: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        deployAndRun(bytecode: BytesLike, input: BytesLike, overrides?: CallOverrides): Promise<string>;
        deployAndSubmit(bytecode: BytesLike, problem: string, overrides?: CallOverrides): Promise<void>;
