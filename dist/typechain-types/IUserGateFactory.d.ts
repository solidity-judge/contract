...
export interface IUserGateFactoryInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "verifySolution", values: [string, string]): string;
    ...
    decodeFunctionResult(functionFragment: "verifySolution", data: BytesLike): Result;
    events: {
...
export interface IUserGateFactory extends BaseContract {
    ...
    functions: {
        ...
        verifySolution(user: string, solution: string, overrides?: CallOverrides): Promise<[boolean]>;
    };
    createGate(username: string, overrides?: Overrides & {
        from?: string | Promise<string>;
    }): Promise<ContractTransaction>;
    ...
    estimateGas: {
        ...
        verifySolution(user: string, solution: string, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        createGate(username: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        ...
        verifySolution(user: string, solution: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
