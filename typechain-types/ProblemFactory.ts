...
export interface ProblemFactoryInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "simpleChecker",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type CreateProblemEvent = TypedEvent<
  ...
  { author: string; id: BigNumber; problem: string; checker: string }
>;
...
export interface ProblemFactory extends BaseContract {
  ...
  callStatic: {
    ...
    ): Promise<[BigNumber, string] & { id: BigNumber; problem: string }>;
  ...
  filters: {
    ...
    "CreateProblem(address,uint256,address,address)"(
      author?: null,
      id?: null,
      problem?: null,
      checker?: null
    ): CreateProblemEventFilter;
    CreateProblem(
      author?: null,
      id?: null,
      problem?: null,
